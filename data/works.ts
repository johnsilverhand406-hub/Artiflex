...
export const modelingWorks: Work[] = [
  ...
  },
  {
    ...
    title: "Миниатюра лучницы",
    review: {
      name: "Игорь",
      text: "Заказывал персонажа для D&D — захотел конкретного лучника. Сгенерировал фотку и скинул ребятам. Ребята уже смоделировали в 3д. Пропорции идеальные. Благодарю.",
      rating: 5
    }
  },
  {
  ...
  },
  {
    ...
    title: "Подставка с логотипом",
    review: {
      name: "Владимир",
      text: "Заказывали брендированную подставку с нашим логотипом для стендов на выставке. Модель сделали быстро, логотип виден чётко, все углы и пазы точные. Напечатали партию — все одинаковые, ни одного брака. Будем сотрудничать и дальше.",
      rating: 5
    }
  },
  {
  ...
  },
  {
    ...
    review: {
      name: "Станислав",
      text: "Давно хотел такой декор для кабинета. Рыцарь с гравировкой на броне, шлем, наплечники — уровень детализации просто поразительный. Особенно впечатлил орнамент на нагруднике — видно каждый завиток. Спасибо.",
      rating: 5
    }
  },
  {
    ...
    title: "Маршрутизатор для проводов",
    review: {
      name: "Денис",
      text: "Постоянно мучился с проводами на столе — заказал кастомный маршрутизатор под конкретное количество кабелей. Прислал схему расположения, ребята сделали всё точно.",
      rating: 5
    }
  },
  {
