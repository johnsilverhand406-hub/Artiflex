import { Printer, Scan, Cpu, Package, Truck, MapPin, Layers } from 'lucide-react';
...
export const SERVICES: Record<string, Service> = {
  fdm: {
    ...
    price: "от 500₽",
    description: "Классическая технология послойного наплавления пластика. Идеально подходит для функциональных прототипов, корпусных деталей, кронштейнов и крупногабаритных макетов. Мы используем профессиональные принтеры с закрытой камерой для обеспечения высокой точности и прочности деталей.",
    features: [
      "Материалы: PLA, PETG, ABS, Nylon, TPU",
      "Точность слоя: от 100 до 300 микрон",
      "Максимальный размер: 300x300x400 мм",
...
export const DELIVERY_STEPS = [
  {
    icon: Layers, 
    title: "Производство",
    desc: "1-3 рабочих дня в зависимости от объема заказа."
  },
  {
    icon: Package,
  ...
  {
    icon: Truck,
    title: "На выбор самые удобные компании",
